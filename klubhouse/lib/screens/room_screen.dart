...
import 'package:klubhouse/data.dart';
import 'package:klubhouse/widgets/user_profile_image.dart';
import 'package:klubhouse/widgets/widget.dart';
          ...
          slivers: [
            ...
            SliverPadding(
              ...
              sliver: SliverGrid.count(
                ...
                children: room.followedBySpeakers.map(
                        (e) => RoomUserProfile(
                          imageUrl: e.imageUrl,
                          size: 66.0,
                          name: e.givenName,
